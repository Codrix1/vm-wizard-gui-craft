          ...
          <Card className="transition-all hover:shadow-lg">
            <CardContent className="p-6 flex flex-col items-center text-center">
              <div className="bg-[#2496ED]/10 p-5 rounded-full mb-4">
                <Dock className="h-12 w-12 text-[#2496ED]" />
              </div>
              <h2 className="text-2xl font-semibold mb-4">Docker Management</h2>
              <p className="text-gray-500 mb-6">
                Build, manage, and deploy Docker containers with a full-featured Docker interface
              </p>
              <Button asChild className="bg-[#2496ED] hover:bg-[#1D7AC1] w-full">
                <Link to="/docker">Manage Docker</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
